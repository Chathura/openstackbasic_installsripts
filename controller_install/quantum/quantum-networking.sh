...
EXT_NET_GATEWAY="192.168.2.253"

# Floating IP range
POOL_FLOATING_START="192.168.2.130"	# First public IP to be used for VMs
POOL_FLOATING_END="192.168.2.150"	# Last public IP to be used for VMs 
