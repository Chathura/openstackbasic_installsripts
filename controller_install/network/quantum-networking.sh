...
EXT_GW_IP="10.10.10.1"

# IP of the Public Network Gateway - The 
# default GW in our official Internet IP address space:
EXT_NET_GATEWAY="10.10.10.1"

# Floating IP range
POOL_FLOATING_START="10.10.10.130"	# First public IP to be used for VMs
POOL_FLOATING_END="10.10.10.150"	# Last public IP to be used for VMs 
